...
import 'package:lapor_kasat/app/pages/notifikasi.dart';
...
class CustomBody extends StatelessWidget {
  ...
  const CustomBody({Key? key, required this.imgList, required this.layananList})
      : super(key: key);
...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(),
      body: CustomBody(imgList: imgList, layananList: layananList),
    );
  }
}
